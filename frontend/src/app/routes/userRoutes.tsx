...
const ProfileInfo = lazy(
  () => import('@/features/manage-profile/ProfileInfo'),
)
const Orders = lazy(() => import('@/pages/user/profile/Orders'))
const FavoriteProducts = lazy(
  () => import('@/features/wishlist/FavoriteProducts'),
)
...
const ShoppingCart = lazy(() => import('@/features/cart/ui/ShoppingCart'))
const Checkout = lazy(() => import('@/features/checkout/ui/Checkout'))
const CompleteCheckout = lazy(
  () => import('@/features/checkout/ui/CompleteCheckout'),
)
const PaymentSuccess = lazy(
  () => import('@/features/checkout/ui/PaymentSuccess'),
)
const PaymentFailed = lazy(() => import('@/features/checkout/ui/PaymentFailed'))
