...
import { useRemoveCartItems } from '@/features/cart'
...
import { useAddresses } from '@/features/manage-address'
...
export default function Checkout() {
  ...
  const handleContactChange = (field: keyof ContactFormData, value: string) => {
    setContactData((prev: ContactFormData) => ({ ...prev, [field]: value }))
  }
  ...
  const handlePaymentChange = (
    ...
    setPaymentData((prev: PaymentFormData) => ({ ...prev, [field]: value }))
  }
