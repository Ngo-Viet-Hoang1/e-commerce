      ...
      <div className="relative z-10 flex flex-col items-center space-y-5 text-center md:flex-row md:justify-between md:space-y-0 md:text-left">
        ...
        >
          ...
          <p className="max-w-lg text-amber-700">
            Discover the latest gadgets, accessories, and smart devices. Enjoy
            exclusive opening deals with special discounts for a limited time
            only.
          </p>
        </div>
        ...
        >
          <button className="group relative overflow-hidden rounded-md bg-linear-to-r from-amber-600 to-amber-700 px-6 py-3 font-medium text-white shadow-md transition-all hover:shadow-lg">
