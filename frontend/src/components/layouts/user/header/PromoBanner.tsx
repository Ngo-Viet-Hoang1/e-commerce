...
function PromoBanner() {
  ...
  return (
    <div className="relative overflow-hidden bg-linear-to-r from-teal-600 to-cyan-600 px-6 py-2 shadow-md">
      ...
      <div className="relative z-10 flex items-center justify-between">
        ...
        <button
          className="ml-3 shrink-0 text-white focus:outline-none"
